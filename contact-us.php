...
<body>
    ...
    <section class="container mb-5">
        ...
        <div class="contact-info mt-5" style="display: block;">
                        ...
                        <form>
                            <div class="from-inputs ">
                                <div class="type_1">
                                    ...
                                    <input type="text" name="fristname" id="fullname">
                                </div>
                                <div class="type_1">
                            ...
                            <div class="from-inputs ">
                                <div class="type_1">
                                    <label for="topic" class="form-label">Which topic best matches your
                                        question?</label>
                            ...
                            <div class="from-textarea">
                                <div class="type_1">
                                    <label for="textareaInput" class="form-label">Your Message*</label>
                                        ...
                                        <defs>
                                            <clipPath id="clip0_1774_2">
                                                <rect width="20" height="20" fill="white"
                                                    transform="translate(0.365234 0.5)">
                                                </rect>
                                            </clipPath>
                                        </defs>
                                    </svg>
