...
<body>
    ...
    <div class="container">
        <div class="ak-section-heading ak-style-1 ak-type-1">
            <div class="background-text">Our Services</div>
        </div>
        <div class="cta" data-aos="fade-right">
            <span class="border-pr"></span>
            <span class="border-wh"></span>
            <div class="cta-info">
                <h3 class="cta-title" data-aos="fade-left" data-aos-delay="100">Defining the Vision. Planning with
                    Intent.
                </h3>
                <p class="cta-desp">Pre-production is where ideas are shaped into strategy. We begin by understanding
                    your brand, objectives, and audience. Through detailed planning and collaboration, we design a
                    creative framework that ensures the production is not only visually compelling, but aligned with
                    your goals.
                </p>
            </div>
        </div>
    ...
    <section class="container">
        <div class="choose-us-container-extents mb-4">
            <div class="choose-us-contain">
                <div class="choose-us-info" data-aos="fade-up">
                    ...
                    <div class="ak-section-heading ak-style-1">
                        ...
                        <h2 class="ak-section-title">Pre-Production</h2>
                        <p class="ak-section-subtitle">Defining the Vision. Planning with Intent.</p>
                    </div>
                    <p class="ak-section-subtitle mt-4">Pre-production is where ideas are shaped into strategy. We begin
                        by understanding your brand, objectives, and audience. Through detailed planning and
                        collaboration, we design a creative framework that ensures the production is not only visually
                        compelling, but aligned with your goals.
                    </p>
                    <div class="stroke-heading-text mt-4">
                        <h3 class="ak-stroke-text hover-color-changes">Scope of Services</h3>
                    </div>
                    ...
                    <ul class="mt-4">
                        <li>Creative ideation and concept development</li>
                        <li>Scripting (voiceover, dialogue, interview prompts)</li>
                        <li>Storyboarding and visual planning</li>
                        <li>Shot lists and technical planning</li>
                        <li>Talent sourcing and casting coordination</li>
                        <li>Location research, permits, and scheduling</li>
                        <li>Budget control and timeline development</li>
                    </ul>
                    <div class="stroke-heading-text mt-4">
                        <h3 class="ak-stroke-text hover-color-changes">Deliverables</h3>
                    </div>
                    <ul class="mt-4">


                        <li>Creative treatment</li>
                        <li>Final script and storyboard</li>
        ...
        <div class="choose-us-container-extents">
            <div class="choose-us-contain">
                ...
                <div class="choose-us-info" data-aos="fade-up">
                    ...
                    <div class="ak-section-heading ak-style-1">
                        <div class="background-text">Services</div>
                        <h2 class="ak-section-title">Production</h2>
                        <p class="ak-section-subtitle">Executing the Vision with Technical Precision</p>
                    </div>
                    <p class="ak-section-subtitle mt-4">Once the plan is in place, we move into full-scale production.
                        Our experienced crew manages every element of the shoot, ensuring a controlled environment that
                        allows for both efficiency and creative freedom. We are equipped to deliver productions of
                        varying scale — from single-day shoots to multi-location, multi-day campaigns.
                    </p>
                    <div class="stroke-heading-text mt-4">
                        <h3 class="ak-stroke-text hover-color-changes">Capabilities</h3>
                    </div>

                    <ul class="mt-4">
                        <li>4K/6K professional video capture</li>
                        <li>Studio and on-location production</li>
                        <li>Multi-camera interviews and live-action filming</li>
                        <li>Cinematic lighting and sound recording</li>
                        <li>Aerial and drone videography (CAA certified)</li>
                        <li>Direction, art direction, and production management</li>
                        <li>Health & safety and risk management compliance</li>
                    </ul>
                    <div class="stroke-heading-text mt-4">
                        <h3 class="ak-stroke-text hover-color-changes">What You Can Expect</h3>
                    </div>
                    <ul class="mt-4">


                        <li>On-time, on-budget production</li>
                        <li>Expert crew and state-of-the-art equipment</li>
                        <li>Production schedule and call sheet</li>
                        <li>Footage securely backed up and logged</li>
        ...
        <div class="choose-us-container-extents">
            <div class="choose-us-contain">
                <div class="choose-us-info" data-aos="fade-up">
                    ...
                    <div class="ak-section-heading ak-style-1">
                        <div class="background-text">Services</div>
                        <h2 class="ak-section-title">Post-Production</h2>
                        <p class="ak-section-subtitle">Crafting the Final Narrative with Detail & Discipline</p>
                    </div>
                    <p class="ak-section-subtitle mt-4">Post-production is where the story comes together. This stage
                        involves shaping the raw footage into a coherent, emotionally resonant, and visually consistent
                        final product. With in-house editors and motion designers, we provide a fast, secure, and highly
                        collaborative post-production workflow.
                    </p>
                    <div class="stroke-heading-text mt-4">
                        <h3 class="ak-stroke-text hover-color-changes">Services include</h3>
                    </div>

                    <ul class="mt-4">
                        <li>Editing and sequence construction</li>
                        <li>Colour correction and cinematic grading</li>
                        <li>Motion graphics, lower thirds, and visual overlays</li>
                        <li>Music selection, sound design, and voiceover integration</li>
                        <li>Subtitle creation (open or closed captions)</li>
                        <li>Multiple language versioning (if required)</li>
                        <li>Mastering and format delivery for broadcast, social, or web</li>
                    </ul>
                    <div class="stroke-heading-text mt-4">
                        <h3 class="ak-stroke-text hover-color-changes">Output</h3>
                    </div>
                    <ul class="mt-4">


                        <li>Final film(s) in required formats</li>
                        <li>Optimised versions for platforms (e.g., YouTube, LinkedIn, Instagram)</li>
                        <li>Thumbnail and cover asset creation</li>
                        <li>Secure cloud-based file delivery and backup</li>
        ...
        <div class="choose-us-container-extents">
            <div class="choose-us-contain">
                <div class="choose-us-info" data-aos="fade-up">
                    ...
                    <div class="ak-section-heading ak-style-1">
                        <div class="background-text">Services</div>
                        <h2 class="ak-section-title">Content Specialisms</h2>
                        <p class="ak-section-subtitle">We produce content across a broad spectrum of formats and
                            sectors</p>
                    </div>
                    ...
                    <ul class="mt-4">
                        <li> Brand Films – Tell your brand’s story with clarity
                            and emotion</li>
                        <li>Product Launches – Showcase innovation with cinematic
                            flair</li>
                        <li>Corporate Videos – Professional, polished
                            communications for internal or external use</li>
                        <li> Event Coverage – Capture the energy and importance
                            of your live events</li>
                        <li> Explainers & Animation – Turn complex messages into
                            engaging, digestible visuals</li>
                        <li>Interviews & Testimonials – Authentic, story-led
                            human narratives</li>
                        <li>Training & Educational Content – Clear, structured learning and instructional video</li>
                    </ul>
                </div>
                <div class="choose-us-info" data-aos="fade-up">
                    ...
                    <div class="ak-section-heading ak-style-1">
                        <div class="background-text">Services</div>
                        <h2 class="ak-section-title">What Sets Us Apart</h2>

                    </div>

                    <ul class="mt-4">
                        <li> Strategic Thinking, Creative Execution:-
                            We bring the insight of a consultancy and the craft of a film studio — ensuring your content
                            is both beautiful and effective.
                        </li>
                        <li> Client-Centric Process:-
                            We tailor our workflow to your business. Whether you’re an agency partner or an internal
                            comms team, we adapt to suit your needs.
                        </li>
                        <li> Technical Expertise, Trusted Crew:-
                            Our directors, DOPs, editors, and crew have experience across commercial, corporate, and
                            creative sectors.
                        </li>
                        <li> Based in the UK, Working Worldwide:-
                            With a London HQ and access to talent and production partners across Europe and beyond, we
                            scale to deliver anywhere.
                        </li>
                        <li> Transparency & Professionalism:-
                            We provide clear quotes, defined timelines, and complete visibility at every stage of the
                            process.
                        </li>
