...
<footer class="footer style-1 footer-bg">
    <div class="container">
        ...
        <div class="footer-content mb-5">
            <div class="footer-info mt-3" data-aos="fade-up">
                <p class="desp">heartbeat-iconAt Story Grid, we combine creativity with strategic thinking to produce
                    bespoke video content that supports your business objectives. Our experienced team of directors,
                    producers, editors, and creative strategists work collaboratively to bring your vision to life with
                    clarity and impact.
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="social-icon">
                                ...
                                <defs>
                                    <clipPath id="clip0_365_2387">
                                        <rect width="16" height="16" fill="white"
                                            transform="translate(-0.000976562 0.975586)"></rect>
                                    </clipPath>
                                </defs>
                            </svg>
                        </a>
                        ...
                        <a href="#" contenteditable="false" style="cursor: pointer;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 0 24 17"
                                fill="none">
                                <path fill="white"
                                    d="M23.498 2.57a2.996 2.996 0 0 0-2.11-2.113C19.456 0 12 0 12 0S4.544 0 2.612.457A2.996 2.996 0 0 0 .5 2.57 30.376 30.376 0 0 0 0 8.5c0 2.065.232 4.088.5 5.93a2.996 2.996 0 0 0 2.11 2.113C4.544 17 12 17 12 17s7.456 0 9.388-.457a2.996 2.996 0 0 0 2.11-2.113c.27-1.84.5-3.865.5-5.93 0-2.065-.232-4.088-.5-5.93zM9.75 12.25V4.75l6 3.75-6 3.75z" />
                            </svg>
            ...
            <div class="footer-menu-one" data-aos="fade-up" data-aos-delay="50" data-aos-duration="500">
                <div class="footer-menu">
                    ...
                    <a href="about.php" class="menu-item text-hover-animaiton white">About</a>
                    <a href="service.php" class="menu-item text-hover-animaiton white">Services</a>
                    <a href="project.php" class="menu-item text-hover-animaiton white">Project</a>

                    <a href="contact-us.php" class="menu-item text-hover-animaiton white">Contact Us</a>
                </div>
            </div>
            <div class="footer-menu-two" data-aos="fade-up" data-aos-delay="100" data-aos-duration="500">
                <div class="footer-menu">
                    <p class="menu-title">Policy</p>
                    <a href="privacy-policy.php" class="menu-item text-hover-animaiton white">Privacy Policy</a>
                    <a href="term-condition.php" class="menu-item text-hover-animaiton white">Term And Conditon</a>
